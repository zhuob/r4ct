...
ex_df1 <- r4ct::click_data
ex_df2 <- r4ct::risk_table
...
```
Please note that you should click the position where the KM curve has a drop.
```{r, echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("www/click2.png")
```
...
Should you experience any error message, or you have any suggestion to improve this shiny app, please do not hesitate to contact **Bin Zhuo** <bzhuo@amgen.com> at Modeling and Simulation Team, Design & Innovation. 
